...
#include "rom/gpio.h"               // GPIO definitions for camera blink
#include "freertos/FreeRTOS.h"      //
#include "freertos/task.h"          // xTaskCreate() define function
#include "esp_log.h"
...
#define FLASH_LED_GPIO GPIO_NUM_4               // GPIO pin connected to flash led
